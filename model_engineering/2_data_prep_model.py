...
def main():
    ...
    values_with_labels.drop(columns=['district_code', 'water_quality','subvillage', 'ward', 'installer','source', 'basin', 'gps_height', 'extraction_type', 'payment', 'amount_tsh'])
    ...
    pip = preprocessor_pipeline('BaseNEncoder')
